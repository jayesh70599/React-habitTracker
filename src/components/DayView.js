...
const DayView = ({day}) => {
  ...
  return (
    <div className="day-container">
      ...
      <i className={day.isDone===true?"fa-solid fa-circle-check circle-icon green":"fa-solid fa-circle-check circle-icon"} onClick={markToDone}></i>
      <i className={day.isDone===false?"fa-solid fa-circle-xmark circle-icon red":"fa-solid fa-circle-xmark circle-icon"} onClick={markToUnDone}></i>
